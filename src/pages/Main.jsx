                ...
                <SwiperSlide>
                    <div className="second_block">
                        ...
                        <div className="second_block_intro">
                            ...
                            <p>
                                안녕하세요, AI 챗봇 시스템 개발과 풀스택 개발을 겸하는 최수환입니다. <br />
                                개발자 교육과정과 AI 프로젝트들을 통해 꾸준히 성장해왔습니다. <br />
                                새로운 도전을 즐기며, 맡은 일은 끝까지 완벽하게 해내는 것을 추구합니다. <br />
                            </p>
                            <ul>
                                <li>
                                    #꼼꼼함
                        ...
                        <div className='right_box'>
                            ...
                            <div className='logo_wrapper'>
                                ...
                                <div className='right_box_logo2'>
                                    ...
                                    <div className='logo_box'>
                                        <img src='/skills/vuejs.svg' alt='logo_vuejs' className='tilt-animation' />
                                    </div>
                                </div>
                                <h2>
                                    Library
